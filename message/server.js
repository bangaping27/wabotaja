...
module.exports = (hazn) => {
    hazn.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = ['6285231641828@s.whatsapp.net']
            ...
            switch (cmd) {
                ...
                case 'help':
                    ...
                    var own = '6285231641828@s.whatsapp.net'
                ...
                case 'jadibot':
                    ...
                    break
                case 'sc':
                    await hazn.sendMessage(from, '*Script*: ', MessageType.text, { detectLinks: true })
                    break;
                case 'd':
