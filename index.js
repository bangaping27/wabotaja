...
global.mods = [`6285231641828@s.whatsapp.net`]
global.prems = [`62852316418280@s.whatsapp.net`]

global.dfail = (type, m, conn) => {
    let msg = {
        owner: 'Perintah ini hanya dapat digunakan oleh Owner Nomor!',
        mods: 'Perintah ini hanya dapat digunakan oleh Moderator!',
        premium: 'hanya untuk member Premium, chat owner untuk jadi premium! ketik *.kontak*',
